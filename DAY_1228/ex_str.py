...
# ----------------------------------------------------------
# 문자/글자 안에서 일 부분만 추출 해서 다루기 ==> 인덱싱(Indexing)
# - 왼쪽 ==> 오른쪽 : 0, 1, ...
# - 오른쪽 ==> 왼쪽 : -1, -2, ...
...
# ---------------------------------------------------------------
# 문자/글자 안에서 일 부분만 추출 해서 다루기 ==> 슬라이싱(Slicing)
# - 원소/요소 추출 규칙/문법 => 변수명[시작 인덱스 : 끝 인덱스 + 1 : 간격]
# - 조건 : 연속된 인덱스 또는 규칙이 있는 인덱스
# ---------------------------------------------------------------

# Happy만 화면에 출력 하기 => 슬라이싱으로 출력 하기
print(f'msg[0 : 4] => {msg[0 : 4]}')
print(f'msg[0 : 5] => {msg[0 : 5]}')

# 2024!만 화면에 출력하기 => 슬라이싱으로 출력 하기
print(f'msg[15 : 20] => {msg[15 : 20]}')
print(f'msg[-5 : 20] => {msg[-5 : 20]}')

# 첫 번째부터 시작하는 경우 시작 인덱스 생략 가능
print(f'msg[0 : 4] => {msg[0 : 5]}, msg[: 5] => {msg[: 5]}')

# 끝까지 인 경우 마지막 인덱스 생략 가능
print(f'msg[-5 : 20] => {msg[-5: ]}, msg[-5: ] => {msg[-5: ]}, msg[15:] => {msg[15:]}')
