...
# - 범위에 포함되는 숫자 데이터는 원소/요소 라고 함 => 인덱싱
# ---------------------------------------------------------------
...
# - 시작값 => 기본 : 1       range(1, 10) => 5 <= ~ < 10
# - 시작값 => 기본 : 5       range(5, 10) => 5 <= ~ < 10
# ---------------------------------------------------------------
# 1 ~ 30 범위에서 3의 배수로 구성된 리스트 생성
...
# - 시작값 => 기본 : 1       range(1, 10) => 5 <= ~ < 10  1, 2, 3, 4, 5, 6, 7, 8, 9
# - 시작값 => 기본 : 5       range(1, 10, 2) => 5 <= ~ < 10  1, 3, 5, 7, 9
# ---------------------------------------------------------------
